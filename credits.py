...
def temp_main():
  ...
  credit_list = ["CREDITS - Space Adventures"," ","Software Developer - Emily Probin","Senior Programmer - Emily Probin", "Project Manager - Emily Probin", "Graphics - Kenney.nl", " ", "Testers", "Emily Probin", "Sarah Burns", " ", "Thanks To", "Mr Currie", "Ms Laing", "Rob Probin", "Sarah Burns", "Brogan Parry"]
